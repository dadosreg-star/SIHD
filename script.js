...
document.getElementById('loginBtn').addEventListener('click', function() {
    const usuarioInformado = document.getElementById('userInput').value;
    const senhaInformada = document.getElementById('passInput').value;
    const erroMsg = document.getElementById('loginError');

    const usuarioCorreto = "Wasley";
    const senhaCorreta = "Wasley@2026";

    if (usuarioInformado === usuarioCorreto && senhaInformada === senhaCorreta) {
...
let graficoSexoChart = null;
let graficoEspecChart = null;
let graficoHospitalChart = null; 
let graficoTipoAtendChart = null; 
let graficoComplexidadeChart = null; 
let graficoFinanciamentoChart = null; 
let graficoFaecTpChart = null; 
let graficoIdadeChart = null; 
let dadosGlobais = [];
let mapaMunicipios = {}; 
...
// -------------------------------------------------------------
const mapaHospitais = {
    "2184834": "BOM SAMARITANO",
    "2208172": "SANTA ROSÁLIA",
    "2210924": "PHILADELFIA",
    "2211254": "RAIMUNDO GOBIRA",
    "7712170": "UNIMED",
    "9644040": "OCULAR"
};

const mapaLeitos = {
    "1": "CIRÚRGICO", "2": "OBSTÉTRICOS", "3": "CLÍNICOS", "7": "PEDIÁTRICOS",
    "01": "CIRÚRGICO", "02": "OBSTÉTRICOS", "03": "CLÍNICOS", "07": "PEDIÁTRICOS"
};

const mapaCompetencia = {
...
const mapaSexo = { "1": "MASCULINO", "3": "FEMININO" };

const mapaFinanc = { "4": "FAEC", "6": "MAC", "04": "FAEC", "06": "MAC" };

const mapaTipoAtendimento = {
    "1": "Eletiva", "2": "Urgência", "3": "Acidente Trabal. Emp",
    "4": "Acidente Trajeto Trab", "5": "Outros Acidentes Trânsito", "6": "Outras Lesões/Envenen.",
    "01": "Eletiva", "02": "Urgência", "03": "Acidente Trabal. Emp",
    "04": "Acidente Trajeto Trab", "05": "Outros Acidentes Trânsito", "06": "Outras Lesões/Envenen."
};

const mapaComplexidade = { "2": "MC", "3": "AC", "02": "MC", "03": "AC" };

const mapaFaecTp = {
    "40024": "Cirurgia do aparelho digestivo (inclui pré e pós operatório)",
    "40032": "Transplantes de orgãos, tecidos e células",
    "40049": "Implementar Cirg. CV Pediátrica",
    "40071": "Diagnóstico/tratamento em oncologia",
    "40076": "Hemodinâmica em atendimento de urgência",
    "40080": "Redução das Filas de Procedimentos Eletivos",
    "40082": "Alta Complexidade em Cardiologia"
};

/**
 * DICIONÁRIO SIGTAP - ATUALIZADO COM BASE NA PLANILHA FORNECIDA
 */
...
"0101010095":	"PREVENÇÃO DA COVID-19 NAS ESCOLAS ",
"0101010109":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DAMALÁRIA ",
"0101010117":	"ATIVIDADE DE EDUCAÇÃO PERMANENTE EM SAÚDE DO TRABALHADOR ",
"0101010125":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DE ACIDENTE POR ANIMAIS PEÇONHENTOS. ",
"0101010133":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA CÓLERA. ",
"0101010141":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA DOENÇA DE HAFF. ",
"0101010150":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DE DOENÇAS DIARREICAS AGUDAS. ",
"0101010168":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA ESPOROTRICOSE. ",
"0101010176":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA FEBRE MACULOSA BRASILEIRA. ",
"0101010184":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DE LEISHMANIOSE TEGUMENTAR. ",
"0101010192":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA LEISHMANIOSE VISCERAL. ",
"0101010206":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA LEPTOSPIROSE ",
"0101010214":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA DOENÇA DA RAIVA. ",
"0101010222":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA TOXOPLASMOSE. ",
"0101010230":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DE UMA SÓ SAÚDE. ",
"0101010249":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA HANSENÍASE ",
"0101010257":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA ESQUISTOSSOMOSE. ",
"0101010265":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DO TRACOMA. ",
"0101010273":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DAS GEO-HELMINTÍASES ",
"0101010281":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA ONCOCERCOSE. ",
"0101010290":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA FILARIOSE LINFÁTICO. ",
"0101010303":	"ATIVIDADES EDUCATIVAS DA POPULAÇÃO SOBRE A TEMÁTICA DA DOENÇA DE CHAGAS. ",
...
"0101050151":	"OFICINA COLETIVA DE SHANTALA ",
"0101050160":	"ATIVIDADE COLETIVA DE AYURVEDA ",
"0101050178":	"ATIVIDADE COLETIVA DE ANTROPOSOFIA APLICADA À SAÚDE ",
"0101050186":	"ATIVIDADES DE PRODUÇÃO DE ARTE, CULTURA, MEMÓRIA COLETIVA E GERAÇÃO DE RENDA. ",
"0101050194":	"ATIVIDADES COLETIVAS DE INTEGRAÇÃO COM A COMUNIDADE, CIDADE E TERRITÓRIO ",
"0101050208":	"ACOLHIMENTO INICIAL POR CENTRO DE CONVIVÊNCIA. ",
"0101050216":	"FORTALECIMENTO DO PROTAGONISMO DE USUÁRIOS E SEUS FAMILIARES ",
"0101050224":	"PRÁTICAS EXPRESSIVAS E COMUNICATIVAS EM CECO ",
"0101050232":	"ATIVIDADES DE VALORIZAÇÃO DA CULTURA TRADICIONAL, POPULAR E DIVERSIDADE ÉTNICO-RACIAL. ",
"0101050240":	"ATIVIDADES DE COMUNICAÇÃO, ARTE E EXPRESSÃO URBANA COMO PROTAGONISMO DE ADOLESCENTES E JOVENS. ",
"0101050259":	"ATIVIDADES VOLTADAS À CONVIVÊNCIA INTERGERACIONAL ",
"0101050267":	"AÇÕES PARA AMPLIAÇÃO DO ACESSO DAS CRIANÇAS E DOS ADOLESCENTES EM ATIVIDADES DE CONVIVÊNCIA, ARTE, CULTURA E LAZER ",
...
"0202010058":	"DETERMINAÇÃO DE CURVA GLICÊMICA C/ INDUÇÃO POR CORTISONA ( 5 DOSAGENS) ",
...
"0202010759":	"TESTE DE TOLERÂNCIA A INSULINA / HIPOGLICEMIANTES ORAIS ",
...
"0202030245":	"PROVA TUBERCULÍNICA (PT) ",
...
"0202031373":	"DOSAGEM DE ANTICORPOS ANTIGLIADINADEAMINADA IGG ",
"0202031381":	"TESTE TREPONÊMICO LABORATORIAL PARA DETECÇÃO DE SÍFILIS PARA POPULAÇÃO GERAL (EXCETO GESTANTE, PARCEIRO OU PARCERIA) ",
"0202031390":	"TESTE TREPONÊMICO LABORATORIAL P/ DETECÇÃO DE SÍFILIS EM GESTANTE ",
"0202031403":	"TESTE TREPONÊMICO LABORATORIAL P/ DETECÇÃO DE SÍFILIS EM PARCEIRO OU PARCERIA DE GESTANTE ",
...
"0202031446":	"PESQUISA LABORATORIAL DE ANTÍGENO DE SUPERFÍCIE DO VÍRUS DA HEPATITE B (HBSAG) PARA POPULAÇÃO GERAL (EXCETO GESTANTE, PARCEIRO OU PARCERIA) ",
"0202031454":	"PESQUISA LABORATORIAL DE ANTÍGENO DE SUPERFÍCIE DO VÍRUS DA HEPATITE B (HBSAG) EM GESTANTE ",
"0202031462":	"PESQUISA LABORATORIAL DE ANTÍGENO DE SUPERFÍCIE DO VÍRUS DA HEPATITE B (HBSAG) EM PARCEIRO OU PARCERIA DE GESTANTE ",
...
"0202031500":	"PESQUISA LABORATORIAL DE ANTÍGENOS DE HIV E/OU ANTICORPOS ANTI-HIV-1 OU ANTI-HIV-2 PARA POPULAÇÃO GERAL (EXCETO GESTANTE, PARCEIRO OU PARCERIA) ",
"0202031519":	"PESQUISA LABORATORIAL DE ANTÍGENOS DE HIV OU ANTICORPOS ANTI-HIV-1 OU ANTI-HIV-2 EM GESTANTE ",
"0202031527":	"PESQUISA LABORATORIAL DE ANTÍGENOS DE HIV OU ANTICORPOS ANTI-HIV-1 OU ANTI-HIV-2 EM PARCEIRO E PARCERIA DE GESTANTE ",
"0202031535":	"PESQUISA LABORATORIAL DE ANTICORPOS ANTI-HTLV-1 + HTLV-2 PARA POPULAÇÃO GERAL (EXCETO GESTANTE, PARCEIRO OU PARCERIA) ",
"0202031543":	"PESQUISA LABORATORIAL DE ANTICORPOS ANTI-HTLV-1 + HTLV-2 EM GESTANTE ",
"0202031551":	"PESQUISA LABORATORIAL DE ANTICORPOS ANTI-HTLV-1 + HTLV-2 EM PARCEIRO OU PARCERIA DE GESTANTE ",
"0202031560":	"DETECÇÃO DE DNA PROVIRAL DO HTLV-1 E DO HTLV-2 PARA POPULAÇÃO GERAL (EXCETO GESTANTE, PARCEIRO OU PARCERIA) ",
"0202031578":	"DETECÇÃO DE DNA PROVIRAL DO HTLV-1 E DO HTLV-2 EM GESTANTE ",
"0202031586":	"DETECÇÃO DE DNA PROVIRAL DO HTLV-1 E DO HTLV-2 EM PARCEIRO OU PARCERIA DE GESTANTE ",
"0202031594":	"TESTE CONFIRMATÓRIO COM PESQUISA DE ANTICORPOS ANTI-HTLV-1 + ANTI-HTLV-2 PARA POPULAÇÃO GERAL (EXCETO GESTANTE, PARCEIRO OU PARCERIA) ",
"0202031608":	"TESTE CONFIRMATÓRIO COM PESQUISA DE ANTICORPOS ANTI-HTLV-1 + ANTI-HTLV-2 EM GESTANTE ",
"0202031616":	"TESTE CONFIRMATÓRIO COM PESQUISA DE ANTICORPOS ANTI-HTLV-1 + ANTI-HTLV-2 EM PARCEIRO OU PARCERIA DE GESTANTE ",
...
"0202080129":	"CULTURA PARA BACTÉRIAS ANAEROBICAS ",
...
"0202080161":	"IDENTIFICAÇÃO AUTOMATIZADA DE MICRO-ORGANISMOS ",
...
"0202090019":	"ÁCIDO ÚRICO NO LÍQUIDO SINOVIAL E DERRAMES ",
"0202090027":	"ADENOGRAMA ",
"0202090035":	"CITOLOGIA P/ CLAMIDIA ",
"0202090043":	"CITOLOGIA P/ HERPESVIRUS ",
"0202090051":	"CONTAGEM ESPECÍFICA DE CÉLULAS NO LIQUOR ",
"0202090060":	"CONTAGEM GLOBAL DE CÉLULAS NO LÍQUOR ",
"0202090078":	"DETERMINAÇÃO DE FOSFOLIPIDIOS RELAÇÃO LECITINA - ESFINGOMIELINA NO LÍQUIDO AMNIÓTICO ",
...
"0202090132":	"DOSAGEM DE PROTEINAS NO LÍQUIDO SINOVIAL E DERRAMES ",
"0202090140":	"DOSAGEM DE SÓDIO E CLORO NO SUOR (C/ COLETA) ",
"0202090159":	"ELETROFORESE DE PROTEINAS C/ CONCENTRAÇÃO NO LIQUOR ",
...
"0202090230":	"PESQUISA DE CARACTERES FÍSICOS NO LIQUOR ",
"0202090248":	"PESQUISA DE CÉLULAS ORANGIOFILAS ",
"0202090256":	"PESQUISA DE CRISTAIS C/ LUZ POLARIZADA ",
"0202090264":	"ESPERMOGRAMA ",
"0202090272":	"PESQUISA DE RAGOCITOS NO LÍQUIDO SINOVIAL E DERRAMES ",
...
"0202090345":	"TESTE DE GASTROACIDOGRAMA - SECREÇÃO BASAL POR 60 EM 4 AMOSTRAS ",
...
"0202100251":	"EXAME MOLECULAR DE DETECÇÂO DE HPV ",
"0202110010":	"DETECÇÃO DE VARIANTES DA HEMOGLOBINA (DIAGNÓSTICO TARDIO) ",
"0202110028":	"DETECÇÃO MOLECULAR DE MUTAÇÃO EM HEMOGLOBINOPATIAS (CONFIRMATORIO) ",
"0202110036":	"DETECÇÃO MOLECULAR EM FIBROSE CÍSTICA (CONFIRMATORIO) ",
"0202110044":	"DOSAGEM DE FENILALANINA (CONTROLE / DIAGNÓSTICO TARDIO) ",
"0202110052":	"DOSAGEM DE FENILALANINA E TSH OU T4 ",
"0202110060":	"DOSAGEM DE FENILALANINA TSH OU T4 E DETECÇÃO DA VARIANTE DE HEMOGLOBINA (COMPONENTE DO TESTE DO PEZINHO) ",
"0202110079":	"DOSAGEM DE TRIPSINA IMUNORREATIVA (COMPONENTE DO TESTE DO PEZINHO) ",
"0202110087":	"DOSAGEM DE TSH E T4 LIVRE (CONTROLE / DIAGNÓSTICO TARDIO) ",
...
"0207020060":	"RESSONÂNCIA MAGNÉTICA DA MAMA ",
...
"0211040037":	"EXAME MICROBIOLÓGICO A FRESCO DO CONTEUDO CÉRVICO-VAGINAL ",
"0211040045":	"HISTEROSCOPIA (DIAGNOSTICA) ",
"0211040053":	"PERSUFLAÇÃO TUBARIA (DIAGNÓSTICA) ",
...
"0213010836":	"DETECÇÃO RÁPIDA DE CLAMÍDIA E GONOCOCO ",
...
"0214010058":	"TESTE RÁPIDO PARA DETECÇÃO DE ANTICORPOS ANTI-HIV PARAPOPULAÇÃO GERAL (EXCETO GESTANTE, PARCEIRO OU PARCERIA) ",
"0214010066":	"TESTE RÁPIDO DE GRAVIDEZ ",
"0214010074":	"TESTE RÁPIDO TREPONÊMICO (SÍFILIS) PARA POPULAÇÃO GERAL(EXCETO GESTANTE, PARCEIRO OU PARCERIA) ",
...
"0214010228":	"TESTE RÁPIDO PARA DETECÇÃO DO ANTÍGENO DE SUPERFÍCIE DO VÍRUS DA HEPATITE B - HBV (HBSAG) PARA POPULAÇÃO GERAL (EXCETO GESTANTE, PARCEIRO OU PARCERIA) ",
...
"0214010295":	"TESTE RÁPIDO PARA DETECÇÃO DE ANTICORPOS CONTRA O VÍRUS DA HEPATITE C PARA POPULAÇÃO GERAL (EXCETO GESTANTE, PARCEIRO OU PARCERIA) ",
...
"0301010366":	"CONSULTA DE PRÉ-NATAL DE GESTANTE E DE PUERPÉRIO DE ALTO RISCO ",
"0301010374":	"CONSULTA DE ACOMPANHAMENTO DE RECÉM-NASCIDO E CRIANÇA EGRESSA DE UNIDADE NEONATAL ",
"0301010382":	"ESTRATIFICAÇÃO DO RISCO CARDIOVASCULAR ",
"0301010420":	"CONSULTA PARA PESSOA ACOMETIDA PELA HANSENÍASE ",
"3010104391":	"º CONSULTA PARA PROFILAXIA PRÉ-EXPOSIÇÃO (PREP) ORAL À INFECÇÃO PELO HIV ",
"0301010447":	"CONSULTA DE SEGUIMENTO PARA PROFILAXIA PRÉ-EXPOSIÇÃO (PREP) ORAL À INFECÇÃO PELO HIV ",
"0301010455":	"CONSULTA PARA PESSOA EM PÓS-ALTA DE HANSENÍASE ",
...
"0301040079":	"ESCUTA INICIAL / ORIENTAÇÃO (ACOLHIMENTO A DEMANDA ESPONTÂNEA) ",
...
"0301040214":	"ATENDIMENTO MULTIPROFISSIONAL PARA ATENÇÃO AO LUTO MATERNO E PARENTAL ",
"0301040222":	"INSERÇÃO DO SISTEMA INTRAUTERINO LIBERADOR DE LEVONORGESTREL 52MG ",
"0301040230":	"RETIRADA DO SISTEMA INTRAUTERINO LIBERADOR DE LEVONORGESTREL 52MG ",
...
"0301050040":	"ASSISTÊNCIA DOMICILIAR TERAPÊUTICA MULTIPROFISSIONAL EM HIV/AIDS (ADTM) ",
...
"0301080283":	"PRÁTICAS EXPRESSIVAS E COMUNICATIVAS ",
...
"0303010240":	"DOSE SUPERVISIONADA NO TRATAMENTO DE HANSENÍASE ",
"0303010258":	"TRATATAMENTO INTRALESIONAL DA LEISHMANIOSE TEGUMENTAR (LT)NÃO COMPLICADA COM ANTIMONIATO DE MEGLUMINA ",
...
"0304020443":	"BLOQUEIO COM DUPLO ANTI-HER-2 DOCARCINOMA DE MAMA HER-2 POSITIVOAVANÇADO/METASTÁTICO - 1ª LINHA ",
"0304020451":	"TERAPIA ANTINEOPLÁSICA SISTÊMICA DO CÂNCER DE MAMA AVANÇADO COM INIBIDOR CDK 4/6 – 1ª LINHA ",
"0304020460":	"TERAPIA ANTINEOPLÁSICA SISTÊMICA DO CÂNCER DE MAMA AVANÇADO COM INIBIDOR CDK 4/6 – 2ª LINHA ",
"0304020478":	"HORMONIOTERAPIA DO CARCINOMA DE MAMA AVANÇADO COM ANTIESTROGÊNICO SUPRESSOR DOS RECEPTORES DE ESTROGÊNIO - 1ª LINHA ",
"0304020486":	"HORMONIOTERAPIA DO CARCINOMA DE MAMA AVANÇADO COM ANTIESTROGÊNICO SUPRESSOR DOS RECEPTORES DE ESTROGÊNIO - 2ª LINHA ",
"0304020494":	"HORMONIOTERAPIA DO CARCINOMA DE MAMA AVANÇADO COM ANÁLOGO SINTÉTICO DO LHRH / GNRH ",
...
"0304050350":	"TERAPIA ANTINEOPLÁSICA SISTÊMICA DO CÂNCER DE MAMAHER-2 POSITIVO OPERADO EM ESTÁDIO III E COM DOENÇA RESIDUAL (ADJUVANTE) ",
...
"0309050030":	"SESSÃO DE ELETROACUPUNTURA/LASER ACUPUNTURA ",
...
"0309050243":	"SESSÃO DE SHANTALA ",
"0309050251":	"TRATAMENTO DE FERIDAS COM PLANTAS MEDICINAIS ",
"0309050260":	"TRATAMENTO DE FERIDAS COM FITOTERÁPICO ",
...
"0311010024":	"ATENÇÃO MULTIPROFISSIONAL EM CUIDADOS PALIATIVOS NA ATENÇÃO PRIMÁRIA ",
...
"0501070010":	"SOROLOGIA DE POSSIVEL DOADOR DE CÓRNEA E ESCLERA ",
...
"0501070150":	"ECOCARDIOGRAMA PARA DOADOR DE CORAÇÃO ",
...
"0503030112":	"CAPTAÇÃO DE MEMBRANA AMNIÓTICA ",
...
"0504050010":	"PROCESSAMENTO DE MEMBRANA AMNIÓTICA ",
...
"0505020149":	"TRANSPLANTE DE INTESTINO DELGADO OU DE ÓRGÃOS MULTIVISCERAIS EM BLOCO ",
...
"0506010228":	"ACOMPANHAMENTO DE PACIENTE NO PRÉ-TRANSPLANTE DE INTESTINO DELGADO OU DE ÓRGÃOS MULTIVISCERAIS EM BLOCO ",
"0506010236":	"ACOMPANHAMENTO DE PACIENTE NO PÓS-TRANSPLANTE DE INTESTINO DELGADO OU DE ÓRGÃOS MULTIVISCERAIS EM BLOCO ",
...
"0603090010":	"ONASEMNOGENO ABEPARVOVEQUE SOLUÇÃO INJETÁVEL 2,0 × 10¹³ VG/ML. (POR FRASCO DE 5,5 ML) ",
"0603090028":	"ONASEMNOGENO ABEPARVOVEQUE SOLUÇÃO INJETÁVEL 2,0 × 10¹³ VG/ML, (POR FRASCO DE 8,3 ML) ",
...
"0604020066":	"DEFERIPRONA 1000 MG LIBERAÇÃO MODIFICADA (POR COMPRIMIDO) ",
...
"0604130015":	"CLORIDRATO DE DONEPEZILA 5 MG (POR COMPRIMIDO) ",
"0604130023":	"CLORIDRATO DE DONEPEZILA 10 MG (POR COMPRIMIDO) ",
...
"0604160062":	"ÁCIDO ZOLEDRÔNICO 0,05 MG/ML(EMBALAGEM 100 ML) ",
...
"0604340087":	"TACROLIMO 0,3 MG/G POMADA DERMATOLÓGICA (10 G) ",
"0604340095":	"TACROLIMO 0,3 MG/G POMADA DERMATOLÓGICA (30 G) ",
"0604340109":	"TACROLIMO 1 MG/G POMADA DERMATOLÓGICA (10 G) ",
"0604340117":	"TACROLIMO 1 MG/G POMADA DERMATOLÓGICA (30 G) ",
...
"0604480024":	"HIDROXIUREIA 100 MG (POR COMPRIMIDO REVESTIDO) ",
...
"0604540086":	"TAFAMIDIS 61 MG (POR CÁPSULA) ",
...
"0604680058":	"RITUXIMABE 100 MG INJETÁVEL (POR FRASCO-AMPOLA DE 10 ML (ORIGINADOR) ",
"0604680066":	"RITUXIMABE 100 MG INJETÁVEL (POR FRASCO-AMPOLA DE 10 ML (BIOSIMILAR A) ",
"0604680074":	"RITUXIMABE 100 MG INJETÁVEL (POR FRASCO-AMPOLA DE 10 ML) (BIOSSIMILAR B) ",
...
"0604710038":	"FUROATO DE MOMETASONA CREME OU POMADA DERMATOLÓGICA DE 1 MG/G ",
...
"0604850034":	"DIPROPIONATO DE BECLOMETASONA + FUMARATO DE FORMOTEROL DI-HIDRATADO + BROMETO DE GLICOPIRRÔNIO (SOLUÇÃO AEROSSOL CONTENDO 120 DOSES PARA INALAÇÃO ORAL DE 100 MCG+6MCG+12,5MCG) ",
"0604850042":	"FUROATO DE FLUTICASONA + BROMETO DE UMECLIDÍNIO + TRIFENATATO DE VILANTEROL (PÓ PARA INALAÇÃO ORAL CONTENDO 30 DOSES PARA INALAÇÃO ORAL DE 100 MCG + 62,5 MCG + 25 MCG) ",
...
"0604880014":	"ROMIPLOSTIM 250 MCG PÓ PARA SOLUÇÃO INJETÁVEL (POR FRASCO) ",
...
"0702050849":	"MATERIAL PARA ABLAÇÃO TÉRMICA POR RADIOFREQUÊNCIA PARA O TRATAMENTO DO CÂNCER DE CÓLON E RETO COM METÁSTASE HEPÁTICA ",
...
"0702120014":	"LÍQUIDO DE PRESERVAÇÃO DE CORAÇÃO P/ TRANSPLANTE (LITRO) ",
"0702120022":	"LÍQUIDO DE PRESERVAÇÃO DE FÍGADO P/ TRANSPLANTE (LITRO) ",
"0702120030":	"LÍQUIDO DE PRESERVAÇÃO DE PANCREAS P/ TRANSPLANTE (LITRO) ",
"0702120049":	"LÍQUIDO DE PRESERVAÇÃO DE PULMÃO P/ TRANSPLANTE (LITRO) ",
"0702120057":	"LÍQUIDO DE PRESERVAÇÃO DE RIM P/ TRANSPLANTE (LITRO) ",
...
"0802010288":	"DIÁRIA DE UNIDADE DE CUIDADOS INTERMEDIÁRIO PEDIÁTRICO ",
"0802010326":	"DIÁRIA DE LEITO DE SUPORTE VENTILATÓRIO PULMONAR PEDIÁTRICO ",
"0802010334":	"ALOJAMENTO PARA PACIENTES EM TRATAMENTO DE RADIOTERAPIA ",
"0802010342":	"ACOMPANHAMENTO DE INTERCORRENCIA POS-CIRÚRGICA ",
"0802010350":	"DIÁRIA DE UTI EM SITUAÇÃO DE INTERCORRÊNCIA POS-CIRÚRGICA ",
"0802010369":	"DIÁRIA DE UNIDADE DE CUIDADOS INTERMEDIÁRIO ADULTO ",
...
"0803010150":	"AJUDA DE CUSTO PARA TRANSPORTE SANITÁRIO INTERESTADUAL PARA PACIENTES EM TRATAMENTO DE RADIOTERAPIA ",
...
"0804030014":	"TELEMONITORAMENTO NAS AÇÕES DE VIGILÂNCIA A SAÚDE (VS) ",
"0804040010":	"TELECONSULTA A CANDIDATOS A TRANSPLANTES ",
"0804040028":	"TELECONSULTA A PACIENTES TRANSPLANTADOS ",
"0804040036":	"TELECONSULTA A DOADORES VIVOS ",
...
"0906010055":	"OCI - GIN3 - PROGRESSÃO DA AVALIAÇÃO DIAGNÓSTICA DE SAÚDE DA MULHER (GINECOLOGIA)- ENDOMETRIOSE PROFUNDA- CASOS COMPLEXOS E PROGRAMAÇÃO CIRÚRGICA "
    ...
    // Pode inserir mais códigos aqui seguindo a mesma estrutura
};

// -------------------------------------------------------------
// FUNÇÕES AUXILIARES E LÓGICA PRINCIPAL
// -------------------------------------------------------------

function formatarProcRea(codigo) {
    if (codigo === undefined || codigo === null || codigo === "") return "";
    let strCodigo = codigo.toString().trim();
    // Garante o padrão de 10 dígitos exigido pelo SIGTAP/SIH
    while (strCodigo.length > 0 && strCodigo.length < 10) {
...
window.onload = function() {
    fetch('https://servicodados.ibge.gov.br/api/v1/localidades/municipios')
        ...
        .then(data => {
            data.forEach(mun => {
                let codigoSIH = String(mun.id).substring(0, 6);
                mapaMunicipios[codigoSIH] = mun.nome + " - " + mun.microrregiao.mesorregiao.UF.sigla;
            });
        })
    ...
    if (file) {
        Papa.parse(file, {
            ...
            complete: function(results) {
                ...
                popularDropdownsDeFiltros(dadosGlobais);
                filtrarERenderizarDados();
            },
            error: function(error) {
                alert("Ocorreu um erro ao ler o ficheiro CSV: " + error.message);
            }
        });
    }
});
...
const filtrosIds = ['anoFilter', 'compFilter', 'cnesFilter', 'financFilter', 'faecTpFilter', 'leitoFilter', 'tipoAtendFilter', 'complexFilter'];
filtrosIds.forEach(id => document.getElementById(id).addEventListener('change', filtrarERenderizarDados));
document.getElementById('municFilter').addEventListener('input', filtrarERenderizarDados);
document.getElementById('procFilter').addEventListener('input', filtrarERenderizarDados);

function popularDropdownsDeFiltros(dados) {
    const sets = {
        ano: new Set(), comp: new Set(), munic: new Set(), cnes: new Set(),
        financ: new Set(), faecTp: new Set(), leito: new Set(), tipoAtend: new Set(),
        complex: new Set(), proc: new Set()
    };

    dados.forEach(linha => {
        if (linha.ANO_CMPT) sets.ano.add(linha.ANO_CMPT.toString().trim());
        if (linha.MES_CMPT) sets.comp.add(linha.MES_CMPT.toString().trim());
        if (linha.MUNIC_RES) sets.munic.add(linha.MUNIC_RES.toString().trim());
        if (linha.CNES) sets.cnes.add(linha.CNES.toString().trim());
        if (linha.FINANC) sets.financ.add(linha.FINANC.toString().trim());
        if (linha.FAEC_TP) sets.faecTp.add(linha.FAEC_TP.toString().trim());
        if (linha.ESPEC) sets.leito.add(linha.ESPEC.toString().trim());
        if (linha.CAR_INT) sets.tipoAtend.add(linha.CAR_INT.toString().trim());
        if (linha.COMPLEX) sets.complex.add(linha.COMPLEX.toString().trim());
        
        let valProc = formatarProcRea(linha.PROC_REA);
        if (valProc) sets.proc.add(valProc);
    });

    // Populando dropdowns (Exemplo reduzido para brevidade, mantendo sua lógica funcional)
    const renderSelect = (id, set, mapa) => {
        const el = document.getElementById(id);
        el.innerHTML = '<option value="all">Todos</option>';
        Array.from(set).sort().forEach(val => {
            let label = (mapa && mapa[val]) ? (id === 'faecTpFilter' ? val + ' - ' + mapa[val] : mapa[val]) : val;
            el.innerHTML += `<option value="${val}">${label}</option>`;
        });
    };

    renderSelect('anoFilter', sets.ano);
    renderSelect('compFilter', sets.comp, mapaCompetencia);
    renderSelect('cnesFilter', sets.cnes, mapaHospitais);
    renderSelect('financFilter', sets.financ, mapaFinanc);
    renderSelect('faecTpFilter', sets.faecTp, mapaFaecTp);
    renderSelect('leitoFilter', sets.leito, mapaLeitos);
    renderSelect('tipoAtendFilter', sets.tipoAtend, mapaTipoAtendimento);
    renderSelect('complexFilter', sets.complex, mapaComplexidade);

    // Datalist Municípios
    const mList = document.getElementById('municipiosList');
    mList.innerHTML = '';
    Array.from(sets.munic).sort((a,b) => (mapaMunicipios[a] || a).localeCompare(mapaMunicipios[b] || b)).forEach(val => {
        mList.innerHTML += `<option value="${mapaMunicipios[val] || val}"></option>`;
    });

    // Datalist Procedimentos
    const pList = document.getElementById('procList');
    pList.innerHTML = '';
    Array.from(sets.proc).sort().forEach(val => {
        let nome = mapaProcedimentos[val] || "Descrição indisponível";
        let display = `${val} - ${nome.length > 28 ? nome.substring(0, 28) + '...' : nome}`;
        pList.innerHTML += `<option value="${display}"></option>`;
    });

    document.getElementById('dashboardLayout').style.display = 'flex';
}

function filtrarERenderizarDados() {
    const f = {
        ano: document.getElementById('anoFilter').value,
        comp: document.getElementById('compFilter').value,
        munic: document.getElementById('municFilter').value.trim().toLowerCase(),
        ...
        tipoAtend: document.getElementById('tipoAtendFilter').value,
        complex: document.getElementById('complexFilter').value,
        procRaw: document.getElementById('procFilter').value.trim().toLowerCase()
    };
    const procCode = f.procRaw.split(' - ')[0];

    const filtrados = dadosGlobais.filter(l => {
        let mAn = (f.ano === 'all') || (l.ANO_CMPT && l.ANO_CMPT.toString().trim() === f.ano);
        let mCo = (f.comp === 'all') || (l.MES_CMPT && l.MES_CMPT.toString().trim() === f.comp);
        let mMun = true;
        if (f.munic !== '') {
            let nome = mapaMunicipios[l.MUNIC_RES] ? mapaMunicipios[l.MUNIC_RES].toLowerCase() : String(l.MUNIC_RES).toLowerCase();
            mMun = nome.includes(f.munic);
        }
        let mCn = (f.cnes === 'all') || (l.CNES && l.CNES.toString().trim() === f.cnes);
        let mFi = (f.financ === 'all') || (l.FINANC && l.FINANC.toString().trim() === f.financ);
        let mFa = (f.faecTp === 'all') || (l.FAEC_TP && l.FAEC_TP.toString().trim() === f.faecTp);
        let mLe = (f.leito === 'all') || (l.ESPEC && l.ESPEC.toString().trim() === f.leito);
        let mTi = (f.tipoAtend === 'all') || (l.CAR_INT && l.CAR_INT.toString().trim() === f.tipoAtend);
        let mCx = (f.complex === 'all') || (l.COMPLEX && l.COMPLEX.toString().trim() === f.complex);
        
        let vP = formatarProcRea(l.PROC_REA);
        let nP = (mapaProcedimentos[vP] || '').toLowerCase();
        let mPr = (f.procRaw === '') || (vP.startsWith(f.procRaw)) || (vP === procCode) || (nP.includes(f.procRaw));
        
        return mAn && mCo && mMun && mCn && mFi && mFa && mLe && mTi && mPr && mCx;
    });
...
function processarDados(dados) {
    let stats = {
        total: dados.length, vTot: 0, vUti: 0, dPerm: 0, obit: 0,
        sexo: {}, espec: {}, hosp: {}, tipo: {}, complex: {}, financ: {}, faec: {}, idade: {}
    };

    dados.forEach(l => {
        let v = parseFloat(l.VAL_TOT) || 0;
        stats.vTot += v;
        stats.vUti += parseFloat(l.VAL_UTI) || 0;
        stats.dPerm += parseInt(l.DIAS_PERM) || 0;
        if (l.MORTE == 1) stats.obit++;

        // Agrupamentos
        const agrupar = (obj, chave, mapa) => {
            let d = mapa[chave] || (chave ? chave.toString() : 'NÃO INFORMADO');
            if (!obj[d]) obj[d] = { internacoes: 0, valor: 0 };
            obj[d].internacoes++;
            obj[d].valor += v;
        };

        agrupar(stats.sexo, l.SEXO, mapaSexo);
        agrupar(stats.espec, l.ESPEC, mapaLeitos);
        agrupar(stats.hosp, l.CNES, mapaHospitais);
        agrupar(stats.tipo, l.CAR_INT, mapaTipoAtendimento);
        agrupar(stats.complex, l.COMPLEX, mapaComplexidade);
        agrupar(stats.financ, l.FINANC, mapaFinanc);
        if (l.FAEC_TP) agrupar(stats.faec, l.FAEC_TP, mapaFaecTp);

        // Lógica Idade
        let anos = (l.COD_IDADE === 4 || l.COD_IDADE === '4') ? (parseInt(l.IDADE) || 0) : 0;
        let f = "10. 82 e + anos";
        if (anos < 1) f = "00. < 1 ano";
        else if (anos <= 9) f = "01. 1 a 9 anos";
        else if (anos <= 18) f = "02. 10 a 18 anos";
        else if (anos <= 27) f = "03. 19 a 27 anos";
        else if (anos <= 36) f = "04. 28 a 36 anos";
        else if (anos <= 45) f = "05. 37 a 45 anos";
        else if (anos <= 54) f = "06. 46 a 54 anos";
        else if (anos <= 63) f = "07. 55 a 63 anos";
        else if (anos <= 72) f = "08. 64 a 72 anos";
        else if (anos <= 81) f = "09. 73 a 81 anos";

        if (!stats.idade[f]) stats.idade[f] = { MASCULINO: { internacoes: 0, valor: 0 }, FEMININO: { internacoes: 0, valor: 0 } };
        let sKey = mapaSexo[l.SEXO] || 'NÃO INFORMADO';
        if (stats.idade[f][sKey]) {
            stats.idade[f][sKey].internacoes++;
            stats.idade[f][sKey].valor += v;
        }
    });

    // Atualiza KPIs
    const fCur = { style: 'currency', currency: 'BRL' };
    document.getElementById('kpiTotal').innerText = stats.total.toLocaleString('pt-PT');
    document.getElementById('kpiValor').innerText = stats.vTot.toLocaleString('pt-BR', fCur);
    document.getElementById('kpiUti').innerText = stats.vUti.toLocaleString('pt-BR', fCur);
    document.getElementById('kpiInternacao').innerText = (stats.vTot - stats.vUti).toLocaleString('pt-BR', fCur);
    document.getElementById('kpiMediaAih').innerText = (stats.total > 0 ? stats.vTot/stats.total : 0).toLocaleString('pt-BR', fCur);
    document.getElementById('kpiDias').innerText = stats.total > 0 ? (stats.dPerm / stats.total).toFixed(1) : 0;
    document.getElementById('kpiObitos').innerText = stats.obit.toLocaleString('pt-PT');

    renderGraficos(stats.sexo, stats.espec, stats.hosp, stats.tipo, stats.complex, stats.financ, stats.faec, stats.idade);
}

// Funções de Renderização permanecem as mesmas (Gráficos Chart.js)
function renderGraficos(sS, sE, sH, sT, sC, sF, sFa, sI) {
    const tip = (d) => ({ callbacks: { label: (c) => [ 'Int: ' + d[c.label].internacoes.toLocaleString('pt-PT'), 'Val: ' + d[c.label].valor.toLocaleString('pt-BR', {style:'currency', currency:'BRL'}) ] } });

    if (graficoSexoChart) graficoSexoChart.destroy();
    graficoSexoChart = new Chart(document.getElementById('graficoSexo'), { type: 'doughnut', data: { labels: Object.keys(sS), datasets: [{ data: Object.keys(sS).map(k => sS[k].internacoes), backgroundColor: ['#3b82f6', '#d81b60', '#666666'] }] }, options: { responsive: true, maintainAspectRatio: false, plugins: { title: { display: true, text: 'Sexo' }, tooltip: tip(sS) } } });

    if (graficoEspecChart) graficoEspecChart.destroy();
    graficoEspecChart = new Chart(document.getElementById('graficoEspec'), { type: 'bar', data: { labels: Object.keys(sE), datasets: [{ label: 'Internações', data: Object.keys(sE).map(k => sE[k].internacoes), backgroundColor: '#3b82f6' }] }, options: { responsive: true, maintainAspectRatio: false, plugins: { title: { display: true, text: 'Leitos' }, tooltip: tip(sE) }, scales: { y: { beginAtZero: true, grid: { display: false } }, x: { grid: { display: false } } } } });

    if (graficoTipoAtendChart) graficoTipoAtendChart.destroy();
    graficoTipoAtendChart = new Chart(document.getElementById('graficoTipoAtend'), { type: 'doughnut', data: { labels: Object.keys(sT), datasets: [{ data: Object.keys(sT).map(k => sT[k].internacoes), backgroundColor: ['#ffc107', '#17a2b8', '#28a745', '#dc3545', '#6f42c1', '#fd7e14'] }] }, options: { responsive: true, maintainAspectRatio: false, plugins: { title: { display: true, text: 'Tipo Atendimento' }, legend: { position: 'bottom' }, tooltip: tip(sT) } } });

    if (graficoHospitalChart) graficoHospitalChart.destroy();
    graficoHospitalChart = new Chart(document.getElementById('graficoHospital'), { type: 'bar', data: { labels: Object.keys(sH), datasets: [{ label: 'Internações', data: Object.keys(sH).map(k => sH[k].internacoes), backgroundColor: '#17a2b8' }] }, options: { indexAxis: 'y', responsive: true, maintainAspectRatio: false, plugins: { title: { display: true, text: 'Hospital' }, tooltip: tip(sH) }, scales: { x: { grid: { display: false } }, y: { grid: { display: false } } } } });

    if (graficoComplexidadeChart) graficoComplexidadeChart.destroy();
    graficoComplexidadeChart = new Chart(document.getElementById('graficoComplexidade'), { type: 'doughnut', data: { labels: Object.keys(sC), datasets: [{ data: Object.keys(sC).map(k => sC[k].internacoes), backgroundColor: ['#28a745', '#dc3545', '#ffc107'] }] }, options: { responsive: true, maintainAspectRatio: false, plugins: { title: { display: true, text: 'Complexidade' }, tooltip: tip(sC) } } });

    if (graficoFinanciamentoChart) graficoFinanciamentoChart.destroy();
    graficoFinanciamentoChart = new Chart(document.getElementById('graficoFinanciamento'), { type: 'doughnut', data: { labels: Object.keys(sF), datasets: [{ data: Object.keys(sF).map(k => sF[k].internacoes), backgroundColor: ['#6f42c1', '#fd7e14'] }] }, options: { responsive: true, maintainAspectRatio: false, plugins: { title: { display: true, text: 'Financiamento' }, tooltip: tip(sF) } } });

    if (graficoFaecTpChart) graficoFaecTpChart.destroy();
    graficoFaecTpChart = new Chart(document.getElementById('graficoFaecTp'), { type: 'bar', data: { labels: Object.keys(sFa), datasets: [{ label: 'Internações', data: Object.keys(sFa).map(k => sFa[k].internacoes), backgroundColor: '#dc3545' }] }, options: { indexAxis: 'y', responsive: true, maintainAspectRatio: false, plugins: { title: { display: true, text: 'Tipo FAEC' }, tooltip: tip(sFa) }, scales: { x: { grid: { display: false } }, y: { grid: { display: false } } } } });
